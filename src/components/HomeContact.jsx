...
export default function HomeContact() {
  return (
    <section className="max-w-5xl w-full  mx-auto p-10 text-linen text-center">
      {/* Tag */}
      ...
      {/* Heading */}
      <h2 className="text-4xl mt-2 md:text-5xl text-center text-linen">
      ...
      <div className="grid md:grid-cols-3 gap-10 mt-16 ">
        ...
        <div className="flex flex-col items-center">
          <svg className="text-brass bg-brass/15 p-2.5 aspect-square rounded-full size-10" width="24"
          ...
          <p className="text-fog mt-1 mb-4">
        ...
        {/* Call */}
        <div  className="flex flex-col items-center">
          <svg className=" text-brass bg-brass/15 p-2.5 aspect-square rounded-full size-10" width="21"
